...
export async function generateMetadata({
  ...
  return buildWorkMetadata(lang, work, mediumLabel);
}
...
export default async function WorkPage({
  ...
  const breadcrumbs = buildBreadcrumbJsonLd([
    { name: dict.works.title, path: localizedPath(lang as Locale) },
    { name: content.title, path: localizedPath(lang as Locale, `works/${work.slug}`) },
  ]);

  return (
    <>
      <JsonLd data={[buildWorkJsonLd(lang as Locale, work, mediumLabel), breadcrumbs]} />
